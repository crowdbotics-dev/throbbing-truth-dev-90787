"""
Django settings for throbbing_truth_dev_90787 project.
...
ROOT_URLCONF = 'throbbing_truth_dev_90787.urls'
...
WSGI_APPLICATION = 'throbbing_truth_dev_90787.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "throbbing_truth_dev_90787 API",
    "DESCRIPTION": "API documentation for throbbing_truth_dev_90787 App",
    "VERSION": "v1",
}
