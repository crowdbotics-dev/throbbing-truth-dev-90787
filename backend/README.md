...
## Project Structure
    ...
    ├── throbbing_truth_dev_90787  # Django project configurations
...
1. Clone this repo and `cd throbbing_truth_dev_90787`
...
2. Clone this repo and `cd throbbing_truth_dev_90787`
